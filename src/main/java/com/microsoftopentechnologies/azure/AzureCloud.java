...
public class AzureCloud extends Cloud {
                            ...
                            plannedNodes.add(new PlannedNode(
                                    ...
                                    Computer.threadPoolForRemoting.submit(new Callable<Node>() {
                                        ...
                                        public Node call() throws Exception {
                                            ...
                                            // Don't clean up at this point.  Mark the machine as
                                            // needing default cleanup if it were to go offline.
    ...
    private static boolean isNodeEligibleForReuse(AzureSlave slaveNode, AzureSlaveTemplate slaveTemplate) {
        // Do not reuse slave if it is not currently marked as blocked for cleanup.
        // Nodes are marked as keep when they are shut down in an orderly manner (shutdown).
